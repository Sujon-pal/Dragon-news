import { A as createSubscribe, B as isEmpty, C as LogLevel, D as ErrorFactory, E as Deferred, F as getModularInstance, G as querystring, H as isMobileCordova, I as getUA, K as querystringDecode, L as isBrowserExtension, M as extractQuerystring, O as FirebaseError, R as isCloudWorkstation, T as Component, U as isReactNative, V as isIE, W as pingServer, c as _getProvider, f as _registerComponent, g as getApp, j as deepEqual, k as base64Decode, n as SDK_VERSION, u as _isFirebaseServerApp, w as Logger, x as registerVersion, z as isCloudflareWorker } from "./index.esm-D1O2VZv5.js";
//#region node_modules/@firebase/auth/dist/cordova/popup_redirect-D_ZWtJhY.js
...
function _checkCordovaConfiguration(auth) {
	...
	_assert(typeof win?.universalLinks?.subscribe === "function", auth, "invalid-cordova-configuration", { missingPlugin: "cordova-universal-links-plugin-fix" });
	_assert(typeof win?.BuildInfo?.packageName !== "undefined", auth, "invalid-cordova-configuration", { missingPlugin: "cordova-plugin-buildInfo" });
	_assert(typeof win?.cordova?.plugins?.browsertab?.openUrl === "function", auth, "invalid-cordova-configuration", { missingPlugin: "cordova-plugin-browsertab" });
	_assert(typeof win?.cordova?.plugins?.browsertab?.isAvailable === "function", auth, "invalid-cordova-configuration", { missingPlugin: "cordova-plugin-browsertab" });
	_assert(typeof win?.cordova?.InAppBrowser?.open === "function", auth, "invalid-cordova-configuration", { missingPlugin: "cordova-plugin-inappbrowser" });
}
/**
...
//#endregion
//#region node_modules/@firebase/auth/dist/cordova/index.js
/**
* @license
* Copyright 2021 Google LLC
*
