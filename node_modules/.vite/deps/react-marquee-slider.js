...
var styled_components_browser_esm_exports = /* @__PURE__ */ __exportAll({
	ServerStyleSheet: () => Pt,
...
var import_react, r, i, c, a, l, u, h, d, f, m, y, g, S, b, w, N, C, O, E, A, P, _, I, $, j, x, k, D, M, G, F, q, H, Y, U, J, X, Q, Z, ee, te, ne, oe, ie, pe, fe, me, ye, ge, ve, Se, be, we, Ce, Oe, Ee, Ae, Pe, _e, Ie, $e, je, Te, Ve, Me, Le, Be, qe, Xe, Ke, Qe, Ze, nt, ot, it, ct, lt, ht, pt, yt, gt, vt, Ct, Ot, Pt, _t, It, $t, Rt, jt;
var init_styled_components_browser_esm = __esmMin((() => {
	init_emotion_is_prop_valid_esm();
	import_react = /* @__PURE__ */ __toESM(require_react());
	init_stylis();
	c = "undefined" != typeof process && void 0 !== process.env && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR) || "data-styled";
	a = "active";
	l = "data-styled-version";
	u = "6.4.3";
	h = "/*!sc*/\n";
	d = "undefined" != typeof window && "undefined" != typeof document;
	f = Boolean("boolean" == typeof SC_DISABLE_SPEEDY ? SC_DISABLE_SPEEDY : null !== (i = null !== (r = p("REACT_APP_SC_DISABLE_SPEEDY")) && void 0 !== r ? r : p("SC_DISABLE_SPEEDY")) && void 0 !== i ? i : "undefined" != typeof process && void 0 !== process.env && true);
	m = "sc-keyframes-";
	y = {};
	g = {
	...
	x = /(^-|-$)/g;
	k = /(a)(d)/gi;
	D = (e) => String.fromCharCode(e + (e > 25 ? 39 : 97));
	M = 5381;
	G = (e, t) => {
		let n = t.length;
	...
	fe = `style[${c}][${l}="${u}"]`;
	me = new RegExp(`^${c}\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)`);
	ye = (e) => "undefined" != typeof ShadowRoot && e instanceof ShadowRoot || "host" in e && 11 === e.nodeType;
	ge = (e) => {
	...
	je = 47;
	Te = Symbol.for("sc-keyframes");
	Ve = (e) => null == e || !1 === e || "" === e;
	Me = Symbol.for("react.client.reference");
	Le = F(u);
	Be = class {
		constructor(e, t, n) {
	...
	Ze = Qe.Consumer;
	nt = import_react.createContext(void 0);
	ot = nt.Consumer;
	...
	$t = /:(?:(first)-child|(last)-child|(only)-child|(nth-child)\(([^()]+)\)|(nth-last-child)\(([^()]+)\))/g;
	Rt = `:not(style[${c}])`;
	jt = `style[${c}]`;
}));
//#endregion
//#region node_modules/react-marquee-slider/dist/Child.js
var require_Child = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var Container = __importDefault((init_styled_components_browser_esm(), __toCommonJS(styled_components_browser_esm_exports))).default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: inline-block;\n  position: ", ";\n"], ["\n  display: inline-block;\n  position: ", ";\n"])), function(props) {
		return props.position;
	});
	var Child = function(_a) {
		var children = _a.children, x = _a.x, y = _a.y, scatterRandomly = _a.scatterRandomly;
...
//#endregion
//#region node_modules/react-marquee-slider/dist/util.js
var require_util = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var doesOverlap = function(rect1, rect2, containerRect) {
		if (rect1.right > containerRect.right) return !(rect1.right < rect2.left || rect1.left > rect2.right || rect1.bottom < rect2.top || rect1.top > rect2.bottom) || rect1.right - containerRect.right > rect2.left;
		if (rect2.right > containerRect.right) return !(rect1.right < rect2.left || rect1.left > rect2.right || rect1.bottom < rect2.top || rect1.top > rect2.bottom) || rect2.right - containerRect.right > rect1.left;
...
//#endregion
//#region node_modules/react-marquee-slider/dist/Marquee.js
var require_Marquee = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __makeTemplateObject = exports && exports.__makeTemplateObject || function(cooked, raw) {
		if (Object.defineProperty) Object.defineProperty(cooked, "raw", { value: raw });
		else cooked.raw = raw;
		return cooked;
	...
	var Marquee = react_1.default.memo(function(_a) {
		...
		var _e = react_1.useState(0), totalTries = _e[0], setTotalTries = _e[1];
		var _f = react_1.useState({
			width: 0,
			height: 0
		}), containerSize = _f[0], setContainerSize = _f[1];
		...
		react_1.useEffect(function() {
			if (scatterRandomly) setContainerSize({
				width: containerRef.current.clientWidth,
				height: containerRef.current.clientHeight
			});
		}, [scatterRandomly]);
		react_1.useEffect(function() {
			if (!isNaN(velocity) && velocity > 0) setAnimationDuration(containerRef.current.clientWidth / velocity);
		}, [velocity]);
		react_1.useEffect(function() {
			if (scatterRandomly && nestedUpdateCount < NESTED_UPDATE_LIMIT) {
				...
				if (siblings.length > 0) {
					...
					if (util_1.outOfContainerBounds(childRect, containerRect)) {
						...
						if (!hasOverlaps && siblings.length === childrenPosition.length && childrenPosition.length === children.length) onFinish({ totalTries });
					}
				}
				...
				if (totalTries > 0 && totalTries % resetAfterTries === 0) setChildrenPosition([]);
			}
		}, [
			nestedUpdateCount,
			childrenPosition,
		...
		var renderChild = function(child, index, isOriginal) {
			var pos;
			if (childrenPosition[index] !== void 0) pos = childrenPosition[index];
			return react_1.default.createElement(Child_1.default, __assign({ key: (isOriginal ? "child-original" : "child-clone") + "-" + index }, pos, { scatterRandomly }), child);
		};
		...
		return react_1.default.createElement(Container, { ref: containerRef }, react_1.default.createElement(Mirror, {
			style: __assign(__assign({}, animatedStyle), velocity === 0 ? { transform: "translateX(0)" } : {}),
			direction,
			paused: velocity === 0
		}, filteredChildren.map(function(c, i) {
			return renderChild(c, i, false);
		})), react_1.default.createElement(Mirror, {
			ref: marqueeRef,
			style: __assign(__assign({}, animatedStyle), velocity === 0 ? { transform: "translateX(0)" } : {}),
			direction,
			paused: velocity === 0
		}, filteredChildren.map(function(c, i) {
			return renderChild(c, i, true);
		})), react_1.default.createElement(Mirror, {
			style: __assign(__assign({}, animatedStyle), velocity === 0 ? { transform: "translateX(0)" } : {}),
			direction,
			paused: velocity === 0
...
//#endregion
//#region node_modules/react-marquee-slider/dist/Motion.js
var require_Motion = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __makeTemplateObject = exports && exports.__makeTemplateObject || function(cooked, raw) {
		if (Object.defineProperty) Object.defineProperty(cooked, "raw", { value: raw });
		else cooked.raw = raw;
		return cooked;
	...
	var Motion = function(_a) {
		...
		var _b = react_1.useState({
			width: 0,
			height: 0
		}), earthSize = _b[0], setEarthSize = _b[1];
		var width = Math.pow(Math.pow(radius, 2) / 2, 1 / 2) * 2;
		var animationDuration = 2 * Math.PI * radius / velocity;
		react_1.useEffect(function() {
			setEarthSize({
		...
		return react_1.default.createElement(Container, {
			...
			width: earthSize.width,
			height: earthSize.height
		}, react_1.default.createElement(SolarSystem, {
			style: { animationDuration: animationDuration + "s" },
			width,
			initDeg,
			direction,
			backgroundColor: backgroundColors.solarSystem
		}, react_1.default.createElement(Earth, {
			ref: earthRef,
			style: { animationDuration: animationDuration + "s" },
			initDeg,
			direction,
...
//#endregion
//#region node_modules/react-marquee-slider/dist/Scale.js
var require_Scale = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __makeTemplateObject = exports && exports.__makeTemplateObject || function(cooked, raw) {
		if (Object.defineProperty) Object.defineProperty(cooked, "raw", { value: raw });
		else cooked.raw = raw;
		return cooked;
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var Scale = __importDefault((init_styled_components_browser_esm(), __toCommonJS(styled_components_browser_esm_exports))).default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  transform: scale(", ");\n"], ["\n  transform: scale(", ");\n"])), function(props) {
		return props.scale;
	});
...
//#endregion
//#region node_modules/react-marquee-slider/dist/index.js
var require_dist = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.Motion = __importDefault(require_Motion()).default;
	exports.Scale = __importDefault(require_Scale()).default;
	var util_1 = require_util();
	Object.defineProperty(exports, "randomIntFromInterval", {
		enumerable: true,
		get: function() {
			return util_1.randomIntFromInterval;
		}
	});
	Object.defineProperty(exports, "randomFloatFromInterval", {
		enumerable: true,
		get: function() {
